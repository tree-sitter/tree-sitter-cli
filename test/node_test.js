...
describe("Node", () => {
  ...
  describe(".text", () => {
    it("returns the text of a node generated by .parse(String)", () => {
      const src = "α0 / b👎c👎"
    ...
    it("returns the text of a node generated by .parse(Function)", () => {
      const src = "α0 / b👎c👎";
      const input = offset => src.substr(offset, 4);
      const [numeratorSrc, denominatorSrc] = src.split(/\s*\/\s+/);
    ...
    it("returns the text of a node generated by .parseTextBuffer", async () => {
      const src = "α0 / b👎c👎"
      const [numeratorSrc, denominatorSrc] = src.split(/\s*\/\s+/);
      const tree = await parser.parseTextBuffer(new TextBuffer(src));
      const quotientNode = tree.rootNode.firstChild;
      const [numerator, slash, denominator] = quotientNode.children;
    ...
    it("returns the text of a node generated by .parseTextBufferSync", () => {
      const src = "α0 / b👎c👎"
      const [numeratorSrc, denominatorSrc] = src.split(/\s*\/\s+/);
      const tree = parser.parseTextBufferSync(new TextBuffer(src));
      const quotientNode = tree.rootNode.firstChild;
      const [numerator, slash, denominator] = quotientNode.children;
